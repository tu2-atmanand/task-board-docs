...
Previously, I always used the [Kanban Plugin](https://github.com/mgmeyers/obsidian-kanban) to manage my tasks. It had many amazing features and worked nicely for me, but as soon as I came across the [CardBoard plugin](obsidian://show-plugin?id=card-board) everything changed. The idea of being able to manage all my tasks from the whole vault on a single board amazed me a lot. However, after I used it for few days, I realized there were some important features this plugin was lacking. I had some challenges with contributing to their main project, so I instead decided to start my own plugin. And thats how, Task Board was born.
