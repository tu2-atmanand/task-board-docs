...
- Changed the way how dated columns range works. No more support for infinity. Please refer this : https://tu2-atmanand.github.io/task-board-docs/docs/Features/Types_Of_Columns/#dated
...
- Clicking on edit button inside hover modal is opening another hover modal instead of opening Task Editor. Fixed ✅
