...
This a special type of column, specially introduced after the requests of users to show all the pending tasks inside the column and then user can apply the [Advanced Column Filter](/docs/Features/Advanced_Column_Filter.md) to create a custom filtered view. 
