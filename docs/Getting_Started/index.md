...
All tasks with the [accepted format](/docs/Features/Task_Formats/Overview.md) will be scanned and will be displayed on the board based on the specific [Column Criteria](/docs/Features/Type_of_Columns/Overview.md).

Now you are free to explore the various features of this plugin. Will recommend to start by exploring some of the quick guides we have created in the following section : [How to do anything](/docs/How_To/index.md).
