...
Also know as **note-per-task**. This is a new idea which got popularized through the TaskNotes plugin. Read this docs from TaskNotes to learn more : [The Note-Per-Task Approach](https://tasknotes.dev/core-concepts/). Throughout this wiki, will refer these kind of task as "`task-note`".
