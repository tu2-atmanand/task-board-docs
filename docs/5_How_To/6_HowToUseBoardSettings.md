...
Learn more about all the UI elements of this modal from here : [Board config modal](../7_Components/8_Board_Config_Modal.md).
...
{: .note }
> This settings only works for [Tagged type of columns](../6_Features/5_Types_Of_Columns.md#tagged).
...
**Column Type :** At present the plugin supports 6 different types of columns. Learn more about each of them and how to enter the values to create these columns from here : [Types of Columns](./docs/7_Components/Types_Of_Columns.md).
...
**Column Properties :** You will notice there are further more fields, which are specific to the column type. So, read the [Types of Columns](./docs/7_Components/Types_Of_Columns.md) to understand more about what value to enter based on your requirement.
