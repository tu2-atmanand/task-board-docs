...
### New Features 🎁
- **Map view :** Map, plan, manage and visualize all the dependent-sequential tasks within your project using the power of canvas. Based on a new methodology, [Dependency Flow Planning (DPF)](https://github.com/tu2-atmanand/Task-Board/discussions/400). | #301
- **Task Notes :** Show normal notes as task cards on Task Board. Easily add reminders and other properties on your notes. Integration with [TaskNotes plugin](https://github.com/callumalpass/tasknotes). | #424
...
- **Add or Task Editor** can now work as modal as well as a tab, so it can be now opened inside a new window to have multiple views opened at the same time. | #382, #67
