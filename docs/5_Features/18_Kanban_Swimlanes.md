...
But the specific features which makes this Kanban swimlanes feature in this plugin very unique are :
- **Custom swimlanes**
- **Aggregator swimlane**
- **Exclude columns**
...
Additionally, this swimlanes feature has been implemented using two different layouts : 
