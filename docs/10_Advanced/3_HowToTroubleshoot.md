...
Close and open the Obsidian application and try to see if you are able to reproduce the issue again. If the issue happened again : 
   1. [[4_HowToExportLogs|Export the logs]] and see if there are any logs mentioned in the exported log file which might be related to this issue. Keep this log file with you, so you can submit it to the developer.
   2. If there are no logs generated in the log file, you might find something in the [[5_HowToUseDeveloperToolsWindow|Developer Tool Window]].
