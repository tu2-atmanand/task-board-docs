...
- Manually typing it within a markdown file: [Typing inside note](/docs/How_To/Add_New_Task.md#manual-method)
- Via [**Task Editor**](/docs/Features/Task_Editor.md) (accessed via the "➕" button on the top right of the board itself or via Obsidian's Command Palette).
...
To understand the supported format for adding a task see this wiki : [Supported Task Format](/docs/Features/Task_Formats/Overview.md).

Also ensure that the file is allowed for scanning and you have not applied any [scanning filters](/docs/Features/Filters_for_Scanning.md) for files, folder or tags.

Once you are done with adding all your content, just switch your focus from the current editor to the [Task Board View](/docs/Components/Task_Board_Pane.md) and your task will be automatically added to the Task Board.
...
To learn more about this component, read the following wiki : [Task Editor](/docs/Components/Task_Editor.md).
