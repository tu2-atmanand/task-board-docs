...
- Manually typing it within a markdown file: [Typing inside note](/docs/5_How_To/1_HowToAddNewTask.md#manual-method)
- Via [**Task Editor**](/docs/6_Features/4_Task_Editor.md) (accessed via the "➕" button on the top right of the board itself or via Obsidian's Command Palette.
...
To understand the supported format for adding a task see this : [Supported Task Format](/docs/6_Features/1_Task_Formats.md).

Also ensure that the file is allowed for scanning and you have not applied any [scanning filters](/docs/6_Features/10_Filters_for_Scanning.md) for files, folder or tags.

Once you are done with adding all your content, just switch your focus from the current editor to the [Task Board View](/docs/7_Components/1_Task_Board_Pane.md) and your task will be automatically added to the Task Board.
...
To learn more about this component, read the following wiki : [Task Editor](/docs/7_Components/3_TaskEditor.md).
