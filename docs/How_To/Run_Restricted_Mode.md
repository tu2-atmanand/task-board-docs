...
Currently, the default way of editing your tasks is through the [Task Editor](/docs/Features/Task_Editor.md). But you also have following other options using the [Edit button mode setting](/docs/Settings/Automations.md#edit-button-action) as explained below :
...
You can use the Task Editor feature, by first testig it on your dummy tasks and after you feel that this plugin is not going to brake your tasks, you can make it as your default editing option.